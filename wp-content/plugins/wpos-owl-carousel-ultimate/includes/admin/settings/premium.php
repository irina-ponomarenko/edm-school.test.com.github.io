 ...
 *
 * @package Owl Carousel 2 Ultimate
 * @since 1.0.0
 */
...
<div class="wrap">
	...
	<h2><?php _e( 'Owl Carousel 2 Ultimate - Features', 'owl-carousel-ultimate' ); ?></h2><br />
	...
	<table class="wpos-plugin-pricing-table">
	    ...
	    <thead>
	    	<tr>
	    		...
	    		<th>
	    			<h2>Premium</h2>
	    			<p>Gain access to <strong>Owl Carousel 2 Ultimate</strong> and <strong>all other products</strong> with a single purchase.</p>
	    ...
	    <tfoot>
	    	<tr>
	    		<th></th>
	    		<td></td>
	    		<td><p>Gain access to <strong>Owl Carousel 2 Ultimate</strong> and <strong>all other products</strong> with a single purchase.</p>
	     ...
	     <tbody>
			...
			<tr>
				<th>Content Support  <span>Display short content</span></th>
				<td><i class="dashicons dashicons-no-alt"></i></td>
	    		<td><i class="dashicons dashicons-yes"></i></td>
			</tr>	
	    	
			<tr>
				<th>Loop Control  <span>Infinite scroll control </span></th>
				<td><i class="dashicons dashicons-yes"></i></td>
	    		<td><i class="dashicons dashicons-yes"></i></td>
			</tr>
			<tr>
			...
			<tr>
				<th>Custom Read More link Text <span>Add custom name for read more link</span></th>
				<td><i class="dashicons dashicons-no-alt"></i></td>
				<td><i class="dashicons dashicons-yes"></i></td>
			</tr>
	    	<tr>
				<th>Center Mode <span>Enable centermode or no</span></th>
				<td><i class="dashicons dashicons-no-alt"></i></td>
				<td><i class="dashicons dashicons-yes"></i></td>
			</tr>
			<tr>
				<th>Auto Height <span>Enable Auto height or not</span></th>
				<td><i class="dashicons dashicons-no-alt"></i></td>
				<td><i class="dashicons dashicons-yes"></i></td>
			</tr>
			<tr>
	    		<th>Display Slides for Particular Categories <span>Display only the slides with particular category</span></th>
	    			<td><i class="dashicons dashicons-yes"></i></td>
	    		<td><i class="dashicons dashicons-yes"></i></td>
	    	</tr>
	    	<tr>
				<th>Exclude Some Slides <span>Do not display the slides you want</span></th>
				<td><i class="dashicons dashicons-no-alt"></i></td>
				<td><i class="dashicons dashicons-yes"></i></td>
			</tr>
			<tr>
				<th>Exclude Some Categories <span>Do not display the slides for particular categories</span></th>
				<td><i class="dashicons dashicons-no-alt"></i></td>
				<td><i class="dashicons dashicons-yes"></i></td>
			</tr>
			<tr>
				<th>Slides Order / Order By Parameters <span>Display slides according to date, title and etc</span></th>
				<td><i class="dashicons dashicons-yes"></i></td>
				<td><i class="dashicons dashicons-yes"></i></td>
			</tr>
			<tr>
